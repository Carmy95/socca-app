...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Information du Propriétaire</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Tableau de Bord</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('proprio.index') }}">Propriétaires</a></li>
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-6">
                                <a href="{{ route('proprio.edit',$datas->id) }}" class="btn btn-primary">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6" style="font-size: 35px; text-align:center;padding-top:3%; border-left: 1px solid #007bff">
                                    <img src="{{ asset('storage/'.$datas->photo.'') }}" alt="photo{{ $datas->nom }}" style="border-radius: 100%; border: solid 4px #007bff;width:250px; height:250px; ">
                                </div>
                            </div>
                          </div>
                    </div>
