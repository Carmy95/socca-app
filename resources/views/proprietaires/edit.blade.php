                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="group-form">
                                                        ...
                                                        <input id="name" type="text" name="nom" class="form-control  {{  $errors->first('nom','is-invalid') }}" value="{{ old('nom') ? old('nom') : $data->nom }}" placeholder="NOM DU PROPRIETAIRE">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="group-form">
                                                        ...
                                                        <input id="lastname" type="text" name="prenom" class="form-control  {{  $errors->first('prenom','is-invalid') }}" value="{{ old('prenom') ? old('prenom') : $data->prenom }}" placeholder="PRENOMS DU PROPRIETAIRE">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="group-form">
                                                        ...
                                                        <input id="date" name="date2naissance" type="text" value="{{ old('date2naissance') ? old('date2naissance') : $data->date2naissance->format('d/m/Y') }}" class="form-control  {{  $errors->first('date2naissance','is-invalid') }}" class="form-control  {{  $errors->first('date2naissance','is-invalid') }}" placeholder="DATE DE NAISSANCE DU PROPRIETAIRE">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            @php old('chauffeur') ? $p = old('chauffeur') : $t = $data->fonction_id @endphp
                                                            @php $t == 3 ? $p = 'Oui' : $p = 'Non' @endphp
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-check">
                                                                <input id="chauffeurO" name="chauffeur" {{ $p == 'Oui' ? 'checked' : '' }} class="form-check-input  {{  $errors->first('chauffeur','is-invalid') }}" value="Oui" type="radio">
                                                                <label class="form-check-label" for="chauffeurO">OUI</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-check">
                                                                <input id="chauffeurN" name="chauffeur" {{ $p == 'Non' ? 'checked' : '' }} class="form-check-input  {{  $errors->first('chauffeur','is-invalid') }}" value="Non" type="radio">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="group-form">
                                                        ...
                                                        <input id="tel" name="tel" type="number" class="form-control  {{  $errors->first('tel','is-invalid') }}" value="{{ old('tel') ? old('tel') : $data->tel }}" placeholder="N° Telephone DU PROPRIETAIRE">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="group-form">
                                                        ...
                                                        <input id="mobile" type="number" name="mobile" class="form-control {{  $errors->first('mobile','is-invalid') }}" value="{{ old('mobile') ? old('mobile') : $data->mobile }}" placeholder="N° Mobile DU PROPRIETAIRE">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="group-form">
                                                        ...
                                                        <input id="mail" type="email" name="email" class="form-control  {{  $errors->first('email','is-invalid') }}" value="{{ old('email') ? old('email') : $data->email }}" placeholder="Adresse Email DU PROPRIETAIRE">
