                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="group-form">
                                                        ...
                                                        <input id="name" type="text" name="nom" class="form-control  {{  $errors->first('nom','is-invalid') }}" value="{{ old('nom') ? old('nom') : '' }}" placeholder="NOM DU CHAUFFEUR">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="group-form">
                                                        ...
                                                        <input id="lastname" type="text" name="prenom" class="form-control  {{  $errors->first('prenom','is-invalid') }}" value="{{ old('prenom') ? old('prenom') : '' }}" placeholder="PRENOMS DU CHAUFFEUR">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="group-form">
                                                        ...
                                                        <input id="date" name="date2naissance" type="date" value="{{ old('date2naissance') ? old('date2naissance') : '' }}" class="form-control  {{  $errors->first('date2naissance','is-invalid') }}" placeholder="DATE DE NAISSANCE DU CHAUFFEUR">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="group-form">
                                                        ...
                                                        <input id="tel" name="tel" type="number" class="form-control  {{  $errors->first('tel','is-invalid') }}" value="{{ old('tel') ? old('tel') : '' }}" placeholder="N° Telephone DU CHAUFFEUR">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="group-form">
                                                        ...
                                                        <input id="mobile" type="number" name="mobile" class="form-control {{  $errors->first('mobile','is-invalid') }}" value="{{ old('mobile') ? old('mobile') : '' }}" placeholder="N° Mobile DU CHAUFFEUR">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="group-form">
                                                        ...
                                                        <input id="mail" type="email" name="email" class="form-control  {{  $errors->first('email','is-invalid') }}" value="{{ old('email') ? old('email') : '' }}" placeholder="Adresse Email DU CHAUFFEUR">
